...
{{ Form::hidden('roleid') }}
  ...
  <div class="control-group">
    ...
    <div class="controls">
      {{ Form::xlarge_text('roledesc',null,array('placeholder'=>'Role Description')) }}
    </div>
  </div>
{{ Form::close()}}
</div>
...
<button id="addBtn" class="btn btn-primary" data-loading-text="Saving Role">Save Role</button>
</div>
</div>
...
<div class="modal-footer">
<button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
<button id="editBtn" class="btn btn-primary"  data-loading-text="Updating Role">Update Role</button>
</div>
</div>
