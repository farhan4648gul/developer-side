...
@section('content')
	...
	<div class="row-fluid" >
		...
		{{ Table::body($body)->edit(function($client) {return HTML::link('claims/request/requestDetail/'.$client['id'], 'Edit');})->view(function($client) {return HTML::link('claims/request/requestDetail/'.$client['id'], 'View');})->ignore('id', 'password');}}
		{{ Table::close();}}
	</div>
